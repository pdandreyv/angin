...
?>
			...
			<?php if ( $factorycommercegurus_news_layout == 'grid-news' ) { ?>
					...
					<header class="entry-header">
					<div class="blog-meta">
							<span class="cg-blog-date"><time class="entry-date published updated" datetime="%1$s"><?php the_time( 'F j, Y' ) ?></time></span> <span class="comments"><a href="<?php comments_link(); ?>"><?php comments_number(); ?></a></span>
