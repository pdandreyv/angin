...
if ( !function_exists( 'factorycommercegurus_comment' ) ) :
	...
	add_filter( 'post_thumbnail_html', 'factorycommercegurus_remove_thumbnail_dimensions', 10 );
	add_filter( 'image_send_to_editor', 'factorycommercegurus_remove_thumbnail_dimensions', 10 );

	function factorycommercegurus_remove_thumbnail_dimensions( $html ) {
